...
import querystring.QueryString.{QSParam, QueryStringRep}
...
object SearchCriteriaSerializer {
  ...
  implicit def serializer[A](implicit tokenConverter: TokenConverter[QSParam, A]): Serializer[SearchCriteria[A], QueryStringRep] =
